...
Since the original time series was not stationary according to the ACF test result, the 1st and 2nd order differences were taken and made stationary.
When the 2nd order difference is taken, the series seems to become stationary, but when the 1st order difference is taken, it does not become stationary.
...
However, according to the Shapiro-Wilk test, the residues are not normally distributed. Therefore, the logarithm of the residuals was taken and when the Shapiro test was applied again, it was found to be normally distributed.
